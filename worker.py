...
async def on_message(message):
    ...
    if message.content.startswith('.gif'):
     ...
     barraArri = ':bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread:'
     barraAbaj = ':bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread::bread:'
