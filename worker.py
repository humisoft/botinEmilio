...
async def on_message(message):
    ...
    if message.content.startswith('.gif'):
     ...
     barraArri = '```\n ```'
     barraAbaj = '```\n ```'
     stri = barraArri + ':regional_indicator_u::regional_indicator_r::regional_indicator_l: ' + infoUrl(buscar,0) + ' \n:regional_indicator_t::regional_indicator_a::regional_indicator_g: **' + infoTag(buscar,0) + '**' + barraAbaj
